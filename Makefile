...
#LDSecion is actually set below
...
#Original Optiboot started at 0x7E00 - used 500 bytes
#atmega328: LDSECTIONS  = -Wl,--section-start=.text=0x7e00 -Wl,--section-start=.version=0x7ffe
#Modified Optiboot uses more like 600 bytes.
...
#Original Optiboot: 512 byte boot, SPIEN
#atmega328_isp: HFUSE = DE
#FastOptiboot: 1024 byte boot, SPIEN
