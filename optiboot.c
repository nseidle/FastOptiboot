...
/* Edit History:					   					  */
/*							  							  */
/* 4.5 NSeidle: Added company ID, board ID, xtal ID       */
/*              and the ability to modify UBR on the fly  */
/*              Program is now 542 bytes so it is now     */
/*              a 1k bootloader. 30k can be loaded in 5.6s*/
...
#define COMPANY_ID	0x13 //Some company ID
#define BOARD_ID	0x54 //Some derivative ID
#define XTAL_SPEED	16   //Indicate this board runs at 16MHz
